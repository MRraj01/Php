<header>
	...
	<div class="navbar navbar-dark bg-dark shadow-sm">
		<div class="container"><a href="#" class="navbar-brand d-flex align-items-center"><svg
					...
					<circle cx="12" cy="13" r="4" /></svg><strong>Album</strong></a>
			<div class="u-flexbox u-flexbox-alignCenter u-flex-grow g-gap-medium">
				<div class="c-searchBoxContainer g-gap-small">
					<div class="c-searchBox">
						<form class="u-flexbox u-flexbox-alignCenter"><input placeholder="Search" type="search"><svg
								class="u-pointer">
								< !---->
					...
					< !---->
				</div><button data-cy="register-button" class="c-userRegisterButton o-button"
					data-v-71e5f2a8="">Register </button>
			</div>
		</div>
	</div>